...
if (strlen($_SESSION['login']) == 0) {
  ...
  if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($bd, "insert into tblcomplaints(userId,category,subcategory,complaintType,toleName,complaintDetails,complaintFile) values('$uid','$category','$subcat','$complaintype','$tolename','$complaintdetials','$compfile')");
              ...
              <div class="form-panel">
                ...
                <form class="form-horizontal style-form" method="post" onsubmit="return confirm('Are you sure you want to submit?');" name="complaint" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <label class="col-sm-2 col-sm-2 control-label">Complain</label>
                    <div class="col-sm-4">
                  ...
                  <div class="form-group">
                    ...
                    <label class="col-sm-2 col-sm-2 control-label">Tole Name</label>
                    <div class="col-sm-4">
                      <select name="tolename" class="form-control" required="">
                        <option value="Ganeshthan Tole">Ganeshthan Tole</option>
                        <option value="Paknajol">Paknajol</option>
                        <option value="Bahati Pokhari">Bahati Pokhari</option>
